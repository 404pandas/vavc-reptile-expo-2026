...
const ANIMALS = [
  {
    title: "Argentine Horned Frog",
    slug: "argentine-horned-frog",
    emoji: "",
    diff: "Beginner",
    dc: "diff-beginner",
    pdf: "argentine-horned-frog.pdf",
    size: '4–6"',
    lifespan: "10–15 yrs",
    temp: "75–85°F",
    diet: "Carnivore",
  ...
  },
  {
    ...
    slug: "collared-lizard",
    emoji: "",
    diff: "Moderate",
    dc: "diff-moderate",
    pdf: "collared-lizard.pdf",
    size: '8–14"',
    lifespan: "5–8 yrs",
    temp: "110–120°F",
    diet: "Carnivore",
  ...
  {
    title: "White Tree Frog",
    slug: "white-tree-frog",
    emoji: "",
    diff: "Beginner",
    dc: "diff-beginner",
    pdf: "white-tree-frog.pdf",
    size: '3–5"',
    lifespan: "15–20 yrs",
    temp: "75–85°F",
    diet: "Insectivore",
    ...
    <div class="container">
      ...
      <div style="margin-top:.75rem;">
        <span class="diff-badge ${
          a.dc
        }" style="font-size:.9rem;padding:4px 16px;">${a.diff} Care Level</span>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="quick-stats">
        <div class="stat-item"><span class="stat-value">${
          a.size
        }</span><span class="stat-label">Adult Size</span></div>
        <div class="stat-item"><span class="stat-value">${
          a.lifespan
        }</span><span class="stat-label">Lifespan</span></div>
        <div class="stat-item"><span class="stat-value">${
          a.temp
        }</span><span class="stat-label">Basking Temp</span></div>
        <div class="stat-item"><span class="stat-value">${
          a.diet
        }</span><span class="stat-label">Diet Type</span></div>
      </div>
